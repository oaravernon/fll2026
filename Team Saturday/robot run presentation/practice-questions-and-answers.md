# Practice Questions and Answers - Team Saturday Robot Run Presentation
...
We chose our missions based on strategic thinking and testing:
...
**Reliability Testing:**
- We tested each potential mission many times
- We only chose missions we could complete at least 90% of the time
- We avoided missions that were too risky or unreliable

**Robot Capabilities:**
- We matched missions to what our robot can do well
- We designed our robot and attachments for our chosen missions
- We made sure our robot can reach and interact with the mission models effectively

**Our Mission Set:**
- **M01:** Surface Brushing - reliable and consistent
...
- We check all attachments are secure and properly mounted
- We verify our sensors are calibrated correctly
- We do a final check of our code and programs

**Mission 01 - Surface Brushing:**
- Our robot navigates to the surface brushing mission model
- We use sensors to position accurately
- The robot activates the brushing mechanism
- This mission is reliable and gives us consistent points

**Missions 05, 06, 08 - Silo:**
- Our robot moves to the silo area
- We have an attachment designed to interact with the silo missions
...
- We've planned efficient paths to minimize travel time
- We account for field conditions and potential obstacles
- Every movement is calculated and tested

**Key Point:** Every step is planned, tested, and practiced. We know exactly what should happen!
...
We have strategies for handling problems:

**Prevention:**
- We test our robot many times before competition
- We check everything before every run
...
**Team Communication:**
- We have clear communication during runs
...
### Q5: How did you program your robot?

**Sample Answer:**

We use LEGO SPIKE Prime block-based programming. Here's our approach:

**Programming Environment:**
- We use the LEGO SPIKE Prime app
- It's visual block programming, which makes it easier to understand
...
- We break it down into small, manageable steps
- We program each step and test it individually
...
Consistency and reliability are crucial. Here's how we achieve them:

**Extensive Testing:**
- We test each mission many times - not just once or twice
- We test under different conditions (lighting, field setup)
- We track success rates and only use missions that work consistently
...
- Each person took responsibility for specific missions
- We all contributed to overall strategy and design
...
- We discovered our strengths (some better at programming, others at building)
...
**Key Discovery:** We discovered that robotics combines many skills and we can do it!
...
**Creative Solutions:**
- We designed custom attachments for our specific missions
- We found efficient ways to use sensors for navigation
- We created mission sequences that flow together
...
**Example:** Our mission strategy and attachment design were our innovations - they're specifically designed for our chosen missions and work efficiently together!
...
*Good luck with your robot runs, Team Saturday! You've prepared well - be confident and have fun!*
